...
<!--
[ ] Consider project naming conventions: "Makefile" vs. "-main.R", etc. Quarto doesn't work well with the underscore when using the filename environment.
-->
...
**What**: [Collecting and documenting data](https://github.com/qtalr/lab-05)\
