...
- [ ] change to outcomes/ update for new chapter content
...
<!--  
- [ ] Consider how to document the changes to the scaffolding.
  - [ ] Use R or qmd?
    - Quarto make more sense for documentation, but the rendered HTML appears side-by-side with the script files. This looks messy. Or I don't show the HTML output. Then, later in the book, I introduce how to tie the HTML output to a full website with `_site.yml`? 
...
- [ ] Look at the `#exm-` environment to be able to make refs.
...
- [ ] Add data origin discussion `cedel2_do.csv`
- [ ] Add README discussion on manual steps taken to acquire the data
