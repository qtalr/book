...
- [ ] Focus on analysis: aims, variables, and methods.
  - [ ] Research goals (EDA), research questions (PDA), and hypotheses (IDA).
  - [ ] Variable types (EDA), feature exraction (IDA), and operationalization of variables (IDA).
