...
Consider: 
- [ ] Summarizing this chapter. On first draft it is over 11k words.
  - [ ] Moving (parts of) the analysis sections to the individual chapters on inference, prediction, and exploration?
- [ ] ...
...
```{r}
#| label: summaries-continuous-measures-belc
