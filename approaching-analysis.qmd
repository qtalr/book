...
[Evaluate] Predictive Data Analysis (PDA): Supervised machine learning to predict some target outcome variable. Attempt examine strength of relationships between variables and variable types and the target variable of interest. (examine relationships --data-/ hypothesis-driven)
