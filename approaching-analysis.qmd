...
pacman::p_load(TBDBr, skimr, janitor, kableExtra, effectsize)
...
An hierarchical overview of the relationship between the two main and four sub-types of levels of measurement appear in @fig-info-values.
