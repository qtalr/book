...
- [ ] Reorganize and summarize this chapter to fit between 7-8k words.
  - 2023-08-28: My idea is to significantly trim the Diagnose section.
    - Verify: missing data, anomalies may only need prose and some toy examples.
    - Describe: central tendency, dispersion, and distribution should be considered together. Interdependence should be outlined but not discussed in detail, and referred to as part of the analysis process (i.e. Inspect)
...
```{r}
#| label: aa-packages
pacman::p_load(skimr, janitor, kableExtra, effectsize, tidytext)
```
...
**What**: [Data visualization](https://github.com/qtalr/lessons)\
...
```{r}
#| label: tbl-aa-belc-descriptive-stats
#| tbl-cap: "Central tendency and dispersion of the variables in the BELC dataset"
#| tbl-subcap:
...
: Skewness scores {#tbl-aa-skewness}{tbl-colwidths="[45, 55]" .sm .striped}
...
: Kurtosis scores {#tbl-aa-kurtosis}{tbl-colwidths="[45, 55]" .sm .striped}
...
**What**: [Descriptive assessment of datasets](https://github.com/qtalr/lab-03)\
