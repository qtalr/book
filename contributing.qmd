...
- [ ] 'targets': a look at @Rodrigues2023 for a good overview of the research process.
  - This includes using *renv* (https://rstudio.r-universe.dev/renv#) for package versions, *targets* (https://ropensci.r-universe.dev/targets#) for workflow pipelines, and Rocker project (https://rocker-project.org/) for containerization.
...
## Reproducibility {#sec-contr-reproducibility}
