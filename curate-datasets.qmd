...
read_csv("data/curate-datasets/cd-enntt_do.csv") |> 
  kable() |> 
  kable_styling()
```
...
# Read in *.dat* file as HTML
ns_dat_lines <- 
  read_html("data/curate-datasets/enntt/natives.dat") |> 
  html_elements("line")
...
ns_tok_lines <- 
  read_lines("data/curate-datasets/enntt/natives.tok")
...
ns_dat <-
  combine_dat_tok(
    dat_file = "data/curate-datasets/enntt/natives.dat",
    tok_file = "data/curate-datasets/enntt/natives.tok"
  )
# Preview
glimpse(ns_dat)
...
nns_dat <-
  combine_dat_tok(
    dat_file = "data/curate-datasets/enntt/nonnatives.dat",
    tok_file = "data/curate-datasets/enntt/nonnatives.tok"
  )
# Preview
glimpse(nns_dat)
```
...
read_csv("data/curate-datasets/cd-enntt_curated_dd.csv") |> 
  kable() |> 
  kable_styling()
```
