...
read_rds("assets/listings/journals_linguistics.rds") |>
  tt(width = 1)
```
...
read_rds("assets/listings/journals_humanities.rds") |>
  tt(width = 1)
```
...
read_rds("assets/listings/journals_cl.rds") |>
  tt(width = 1)
```
...
There are a set of guiding principles to accomplish these goals [@Gentleman2007; @Marwick2018], seen in @tbl-fr-repro-research.
...
The project structure in @exm-fr-basic-project meets the minimal structural requirements for reproducible research and is a good starting point for a project scaffold. However, aspects of this structure can be adjusted in minimal or more sophisticated ways to meet the needs of a particular project while still conforming to the principles outlined in @tbl-fr-repro-research, as we will see in @sec-contributing.
