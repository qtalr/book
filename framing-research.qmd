...
In @exm-fr-basic-project, I provide a minimal framework that aligns with the reproducible research principles. 

The *project/* directory is composed of three main sections: *data/*, *output/*, and *scripts/* corresponding to the input, output, and code, respectively.
...
The *scripts/* directory houses the code, with *_main.R* script orchestrating the execution of all project steps.
