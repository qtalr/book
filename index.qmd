...
- [ ] Decide on keeping/ dropping the 'technical questions' and then reformatting the questions section (as in Contributing chapter)
...
# [ ] languageR is not being written (possibly others)
