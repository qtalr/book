...
Feedback is welcome and can be provided through the [hypothes.is](https://web.hypothes.is/) service. A toolbar interface to this service is located on the right sidebar. To register for a free account and join the "qtal_feedback" annotation group [follow this link](https://hypothes.is/groups/wppaYKxy/qtal-feedback). Suggestions and changes that are incorporated will be [acknowledged](#acknowledgements).
:::
...
This textbook was built with the [Quarto](https://quarto.org/) package for R [@R-quarto] and the [bookdown](https://bookdown.org/) package for R [@R-bookdown]. The source code for this book is available on [GitHub](https://github.com/qtalr/book).
...
knitr::write_bib(c(
  .packages(), "quarto", "bookdown", "knitr", "rmarkdown", "languageR", "infer", "rvest", "rsyntax", "rtweet", "tidymodels", "textrecipes", "tidytext", "quanteda.corpora"
), "packages.bib")
```
