...
- [ ] In addition to "Consider this" sections, include "Dive deepers" sections which point readers to more advanced topics.
- [ ] [Search Goodread quotes](https://www.goodreads.com/quotes/search) for quotes to the beginnings of chapters
- [ ] [Search BrainyQuotes](https://www.brainyquote.com/) for quotes.
