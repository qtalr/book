...
knitr::write_bib(c(
  .packages(), "DBI", "dbplyr", "dplyr", "effectsize", "fs", "future", "forcats", "ggplot2", "ggraph", "gibasa", "haven", "igraph", "infer", "janeaustenr", "jiebaR", "jsonlite", "languageR", "lexicon", "lingtypology", "pak", "ProjectTemplate", "purrr", "qtkit", "readr", "readtext", "renv", "reprex", "rsyntax", "rvest", "skimr", "stringr", "swirl", "targets", "TBDBr", "textrecipes", "tidyr", "tidytext", "tidyverse", "tinytex", "tokenizers", "udpipe", "washoku", "wordbankr", "workflowr"
), "textbook-pkgs.bib")
```
