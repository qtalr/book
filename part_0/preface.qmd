...
## Rationale {#sec-preface-rationale}
...
[![](figures/preface-diki.drawio.png){fig-width=80%}]{fig-alt="Data to Insight Hierarchy (DIKI) which is a pyramid with the following levels: Data, Information, Knowledge, and Insight. The Data level is at the bottom and the Insight level is at the top. The Data level is the largest and the Insight level is the smallest."}

Data to Insight Hierarchy (DIKI)\
Adapted from @Ackoff1989 and @Rowley2007.
...
### Chapter level {#sec-preface-structure-chapter}
...
## Resources {#sec-preface-resources}
...
::: {#tbl-resources tbl-colwidths="[15, 70, 15]" .striped}
...
### R packages {#sec-preface-r-packages}

As you progress in your R programming experience, you'll find yourself leveraging code from other R users, which is typically provided as packages. Packages are sets of functions and/ or datasets that are freely accessible for download, designed to perform a specific set of interrelated tasks. They enhance the capabilities of R. Official R packages can be found in repositories like The Comprehensive R Archive Network (CRAN) [@RCommunity2024] or R-universe [@ROpenSci2024], while other packages can be obtained from code-sharing platforms such as GitHub [@Github2024].
...
### Git and GitHub {#sec-preface-git-github}
...
### Getting help {#sec-preface-getting-help}
...
::: {#tbl-support-resources tbl-colwidths="[5, 25, 70]" .striped}
...
## Conventions {#sec-preface-conventions}
...
### Code blocks {#sec-preface-code-blocks}
...
When a reference to a snippet of a file, it will appear as in @lst-r-code.
...
## Activities {#sec-preface-activities}
...
## To the instructor {#sec-preface-instructor}
