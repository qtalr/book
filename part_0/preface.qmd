...
TODO: attempt to have facing pages with the same number of lines
TODO: review corrections and adjust page/ table/ figure breaks across pages
TODO: review and adjust colors in figures (enhance contrast, remove too dark colors)
...
[^nvim]: For those who prefer a text editor, \index{Neovim}Neovim [@Neovim2024] is a popular choice. Neovim is a text editor that is designed to be extensible and customizable. It is a modern version of the classic Vim text editor.
