...
[![](figures/ta-ds-venn.drawio.png){width=70%}]{fig-alt="A Venn diagram with three overlapping circles. The left circle is labeled 'Computing' and the right circle is labeled 'Statistics'. The bottom circle is labeled 'Domain'. The intersection of all three circles is labeled 'Data Science'."}
...
![](figures/ta-data-collection-methods.drawio.png)
