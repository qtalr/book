...
So what are some applications of text analysis? Most public facing applications stem from Computational Linguistic research, often known as **Natural Language Processing**\index{Natural Language Processing (NLP)} (NLP) by practitioners. Whether it be using search engines, online translators, submitting your paper to plagiarism detection software, *etc.* many of the text analysis methods we will cover are at play.
