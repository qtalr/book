...
[![](figures/ta-ds-venn.drawio.png){width=60%}]{fig-alt="A Venn diagram with three overlapping circles. The left circle is labeled 'Computing' and the right circle is labeled 'Statistics'. The bottom circle is labeled 'Domain'. The intersection of all three circles is labeled 'Data Science'."}
...
Observational approaches show complementary strengths and shortcomings. Whereas experimental approaches may diverge from natural language use, observational approaches strive to identify and collected language behavior data in natural, uncontrolled, and unmonitored contexts. This has the benefit of providing a more ecologically valid representation of language behavior.
