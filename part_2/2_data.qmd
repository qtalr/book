...
<!-- ::: {#tbl-corpus-sources tbl-colwidths="[20, 40, 40]" .striped}
| Source | Description | Examples |
|:-------|:------------|:---------|
| Language repositories | Repositories that specialize in language data | Linguistic Data Consortium [@LDC2024], TalkBank [@Macwhinney2024] |
| Data sharing platforms | Platforms that enable researchers to securely store, manage, and share data | GitHub, Zenodo [@Zenodo2013], Open Science Framework [@OSF2024]  |
...
::: {#fig-ud-integration layout="[35, -15, 55]" layout-valign="bottom"}
