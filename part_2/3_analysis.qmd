...
Traditionally, $p$-values have been used to determine the likelihood of rejecting $H_0$. A **$p$-value**\index{p-value} is the probability of observing a test statistic as extreme as the one observed, given that $H_0$ is true. However, $p$-values are not the only metric used to evaluate the likelihood of rejecting $H_0$. Other metrics, such as effect size\index{effect size} and confidence intervals\index{confidence interval}, are also used to interpret the results of hypothesis tests.
