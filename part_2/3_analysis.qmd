...
::: {#second}
```{r}
#| label: fig-data-word-mapper
#| fig-cap: 'Example distribution of the term "Yall" the Word Mapper Project'
#| fig-alt: 'The southern region of the United States show a higher frequency of the term than north and northwest regions.'
#| out-width: '100%'

include_graphics("figures/data-word-mapper.png")
```
:::
...
::: {#tbl-analysis-summary-types tbl-colwidths="[17, 27, 28, 28]" .striped}
...
::: {#tbl-analysis-analysis-types tbl-colwidths="[15, 19, 22, 22, 22]" .striped}
...
[![](figures/analysis-eda-variables.drawio.png)]{fig-alt="A table which has columns labeled as 'feat_1', 'feat_2', on so on. Above, these columns are labeled as 'features'. This figure aims to show that no feature has a special status in exploratory data analysis."}
...
In the following activies, we will build on our understanding of how to summarize data using statistics, tables, and plots. We will dive deeper into the use of {skimr} [@R-skimr] to summarize data and the `ggplot2` package [@R-ggplot2] to create plots. We also introduce producing Quarto tables and figures with appropriate code block options. We will reinforce our understanding of {readr} [@R-readr] to read in data and {dplyr} [@R-dplyr] to manipulate data.
