...
The mode, mean, and median appear in @tbl-aa-belc-central-tendency for the BELC dataset.
...
Let's now consider the relevant central tendency and dispersion of the variables in the BELC dataset, in @tbl-aa-belc-dispersion.
...
: Appropriate summary types for different combinations of variable types. {#tbl-aa-summary-types}{tbl-colwidths="[10, 30, 30, 30]" .striped}
...
: Overview of analysis types. {#tbl-aa-analysis-types}{tbl-colwidths="[12, 22, 22, 22, 22]" .striped}
