...
The project structure in @exm-fr-basic-project meets the minimal structural requirements for reproducible research and is a good starting point for a project scaffold. However, aspects of this structure can be adjusted in minimal or more sophisticated ways to meet the needs of a particular project while still conforming to the principles outlined in @tbl-fr-repro-research, when we return to this topic in @sec-contribute-chapter.
...
**What**: [Understanding the computing environment](https://qtalr.github.io/resources/recipes/recipe-04.html)\
