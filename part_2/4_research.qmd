...
The project structure in @exm-fr-basic-project meets the minimal structural requirements for reproducible research and is a good starting point for a project scaffold. However, aspects of this structure can be adjusted in minimal or more sophisticated ways to meet the needs of a particular project while still conforming to the principles outlined in @tbl-fr-repro-research, as we will see when we return to this topic in @sec-contribute-chapter.
