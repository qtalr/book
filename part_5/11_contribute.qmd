...
::: {#tbl-public-common-components tbl-colwidths="[20, 80]" .striped}
...
::: {#tbl-public-quarto-advantages tbl-colwidths="[5, 25, 70]" .striped}
...
[![](figures/nested-project.drawio.png)](fig-alt="Layers and components of a computational research environment.")
...
```{#lst-quarto-yml .yaml lst-cap="Quarto *_quarto.yml* file"}
project:
  title: "Project title"
  type: website
  render:
...
[![](figures/qtal-big-picture.png)]{fig-alt="Big picture of a reproducible research project"}
...
<!-- [ ] check the PDF on this table -->

::: {#tbl-research-stages-substages tbl-colwidths="[16, 16, 16, 16, 16, 16]" .striped}
