...
### Goals and approach {#sec-pda-goals-approach}
...
The approach to conducting predictive analysis shares some commonalities with exploratory data analysis (@sec-eda-goals-approach) (as well as inferential analysis @sec-inference), but there are also some key differences. Consider the workflow in @tbl-pda-workflow.
...
**How**: Read Recipe 9, complete comprehension check, and prepare for Lab 7.\
