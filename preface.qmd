...
## Rationale {#sec-p-rationale .unnumbered}
...
## Approach {#sec-p-approach .unnumbered}
...
The subsequent parts are directly aligned with the data analysis process. The building blocks of this process are reflected in \index{Data to Insight Hierarchy}**'Data to Insight Hierarchy (DIKI)'** visualized in @fig-diki-hierarchy[^preface-1].
...
### Chapter level {#sec-p-structure-chapter .unnumbered}
...
### R and IDEs {#sec-p-r-ides .unnumbered}
...
For more information and instructions on setting up an R environment consult the following guide.

::: {.callout}
**{{< fa regular file-code >}} Guides**

- [Setting up an R environment](https://qtalr.github.io/qtalrkit/articles/guide-1.html)
:::

### R packages {#sec-p-r-packages .unnumbered}
...
For instructions on how to install the `qtalrkit` package from GitHub and download and use the interactive R programming lessons for this textbook, see the following guide.
...
### Git and GitHub {#sec-p-git-github .unnumbered}
...
For more information and instructions on setting up version control and interacting with GitHub consult the following guide.

::: {.callout}
**{{< fa regular file-code >}} Guides**

- [Setting up Git and GitHub](https://qtalr.github.io/qtalrkit/articles/guide-2.html)
:::

### Getting help {#sec-p-getting-help .unnumbered}
...
: Recommended order for seeking help with R. {#tbl-support-resources tbl-colwidths="[5, 30, 65]"}
...
For information on how to create a minimal reproducible example with the `reprex` package [@R-reprex], consult the following guide.

::: {.callout}
**{{< fa regular file-code >}} Guides**

- [Creating reproducible examples](https://qtalr.github.io/qtalrkit/articles/guide-3.html)
:::

## Conventions {#sec-p-conventions .unnumbered}
...
- [Linked text](https://qtalr.github.io/qtalrkit/)
...
### Code blocks {#sec-p-code-blocks .unnumbered}
...
greetings <- function(name) { # function definition
...
When a reference to a file and its contents is made, it will appear as in @lst-r.

```{#lst-r .r filename="example.R" lst-cap="Example R script"}
# Load libraries
library(tidyverse)
...
### Callouts {#sec-p-callouts .unnumbered}
...
## Activities {#sec-p-activities .unnumbered}
...
**What**: [Intro to Swirl](https://github.com/qtalr/lessons)\
...
**What**: [Writing with code](https://qtalr.github.io/qtalrkit/articles/recipe-0.html)\
...
**What**: [Writing with code](https://github.com/qtalr/lab-00)\
...
## Summary {#sec-p-summary .unnumbered}
...
<!-- ## Questions {#sec-p-questions .unnumbered}

Digital literacy, Research, Programming

- [ ] {{< fa wrench >}} Revise/ add questions.
...
## To the instructor {#sec-p-instructor .unnumbered}

For recommendations on how to use this textbook in your course and to access additional resources, visit the [Instructor Guide](https://qtalr.github.io/qtalrkit/articles/instructor-guide.html) on the companion website.
