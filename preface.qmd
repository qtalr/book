...
- [ ] Consider if the following prose can be incorporated into the above paragraph, or is best to be left out.
...
- [ ] Consider the extent to which the text below aligns with the aims above.
