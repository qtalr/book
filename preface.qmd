...
| `qtalrkit`[^preface-2] | R package with functions for accessing data and datasets, as well as various useful functions developed specifically for this textbook | CRAN/ [GitHub](https://github.com/qtalr/qtalrkit) |
| Resources Kit | Programming tutorials (Recipes), guides to enhance the reader's recognition of how programming strategies are implemented, and other supplementary materials[^preface-3] | [Online](https://qtalr.github.io/qtalrkit/) |
| Lessons | A set of interactive R programming lessons (Swirl) | [GitHub](https://github.com/qtalr/) |
...
[^preface-2]: The `qtalrkit` package [@R-qtalrkit] is not yet available on CRAN but will be in the future.
...
For more information and instructions on setting up an R environment consult the [Setting up an R environment](https://qtalr.github.io/qtalrkit/articles/guide-1.html) guide.
:::
...
For instructions on how to install the `qtalrkit` package from GitHub and download and use the interactive R programming lessons for this textbook, see the [Getting started](https://qtalr.github.io/qtalrkit/articles/qtalrkit.html) guide.
:::
...
For more information and instructions on setting up version control and interacting with GitHub consult the [Setting up Git and GitHub](https://qtalr.github.io/qtalrkit/articles/guide-2.html) guide.
:::
...
For information on how to create a minimal reproducible example with the `reprex` package [@R-reprex], consult the [Creating reproducible examples](https://qtalr.github.io/qtalrkit/articles/guide-3.html) guide.
:::
...
**What**: [Literate Programming and Quarto](https://qtalr.github.io/qtalrkit/articles/recipe-0.html)\
