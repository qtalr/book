...
The purpose of this chapter is to present the rationale behind this textbook, outline the key learning objectives, describe the teaching methodology, and identify the intended audience. Additionally, this chapter will provide readers with a guide to the book's structure and the scope of its content, as well as instructions for the instructor and a summary of supporting resources available. Finally, this chapter will provide readers with information on setting up their computing environment and where to seek support.

<!-- The primary aim of this chapter is to introduce the reader to a comprehensive guide for quantitative text analysis using the R programming language, specifically targeting students, researchers, and professionals in the field of language science. 

The chapter seeks to strike a balance between conceptual understanding and practical application by focusing on intuitive comprehension rather than delving into complex mathematical explanations. By presenting real-world examples drawn from relevant literature, the chapter aims to provide a structured approach that encompasses orientation, foundations, preparation, analysis, and communication. Interactive R programming lessons, concepts, examples, studies, thought questions, demonstrations, and lab exercises are incorporated within each chapter to facilitate learning. 

Additionally, the chapter highlights the availability of resources such as a companion website and a GitHub repository containing interactive R programming lessons (Swirl) and lab exercises to further support the learning process. Ultimately, the goal of this chapter is to equip readers with the necessary skills to conduct and collaborate on reproducible research projects involving textual data. -->
...
The aim of this textbook is to provide readers with foundational knowledge and practical skills in quantitative text analysis using the R programming language. By the end of this textbook, readers will be able to: 
...
| R Lessons | Teach R programming techniques with hands-on interactive exercises | GitHub | Skills 
...
: The general structure of a chapter, including the component, its purpose, and the resource where it is located. {#tbl-structure-approach}{tbl-colwidths="[15, 55, 15, 15]"}


The following sections provide a more detailed description of the structure and approach of this textbook.
