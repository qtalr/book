...
At the chapter level, both conceptual and programming skills are developed in stages[^preface-3]. The chapter-level structure is consistent across chapters and can be seen in Table 1.
