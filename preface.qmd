...
The aims and approach described above is reflected in the overall structure of the book and at the chapter level. At the book level, there are five interdependent parts: 
...
The DIKI Hierarchy highlights the stages and intermediate steps required to derive insight from data. Part II "Foundations" @part-foundations provides a conceptual introduction to the DIKI Hierarchy and establishes foundational knowledge about data, information, knowledge, and insight which is fundamental to developing a viable research plan. 
...
he resources that are available to support learning, and the learning stages.
...
In **Part II "Foundations"** we will build up a framework to contextualize quantitative data analysis using the Data to Insight (DIKI) Hierarchy in 
