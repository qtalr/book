...
Choosing to install R and an IDE on your personal computer, which is know as your **local environment**, is not the only option to work with R. Other options include working with R in a **remote environment** or a **virtual environment**.
