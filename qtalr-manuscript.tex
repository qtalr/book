...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, colback=white, breakable, leftrule=.75mm, arc=.35mm, opacityback=0, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, colback=white, breakable, leftrule=.75mm, arc=.35mm, opacityback=0, toprule=.15mm, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, rightrule=.15mm, bottomrule=.15mm, left=2mm, coltitle=black, bottomtitle=1mm]
