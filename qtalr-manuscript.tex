...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, colframe=quarto-callout-color-frame, toprule=.15mm, arc=.35mm, breakable, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colbacktitle=quarto-callout-caution-color!10!white, breakable, rightrule=.15mm, bottomrule=.15mm, colback=white, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, toprule=.15mm, toptitle=1mm, arc=.35mm, coltitle=black, opacitybacktitle=0.6, left=2mm]
