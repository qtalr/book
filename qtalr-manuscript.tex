...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, boxrule=0pt, enhanced, colback={codebgcolor}, sharp corners, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
\@ifpackageloaded{fontawesome5}{}{\usepackage{fontawesome5}}
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colback=white, opacityback=0, arc=.35mm, colframe=quarto-callout-color-frame, bottomrule=.15mm, breakable, left=2mm, rightrule=.15mm, toprule=.15mm]
...
variable has two levels: NP and PP. A potential research question fo a
...
chance\footnote{Given the fact that we added jitter to accommodate the
  zeros, it may actually make more sense to compare medians, rathern
  than means. But to compare these results with the results from the
...
TThe confidence interval includes 0, which suggests that the observed
...
The first steps are found in
(\citeproc{ref-xm-ida-num-bi-edu}{\textbf{xm-ida-num-bi-edu?}}).
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, arc=.35mm, bottomrule=.15mm, breakable, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, left=2mm, colbacktitle=quarto-callout-caution-color!10!white, rightrule=.15mm, toptitle=1mm]
