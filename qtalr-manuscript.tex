...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, enhanced, breakable, boxrule=0pt, frame hidden, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
\@ifpackageloaded{fontawesome5}{}{\usepackage{fontawesome5}}
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, breakable, left=2mm, colframe=quarto-callout-color-frame, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, colback=white, toprule=.15mm]
...
Our stat is 0.74 and the confidence interval limits are 0.724 and 0.756.
...
# A tibble: 3 x 3
  ...
  <chr>               <dbl>    <dbl>
1 intercept          -0.667   -0.445
2 length_ratio_log   -1.79    -1.51 
3 modalitywritten     0.804    1.21 
\end{verbatim}
