...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colback=white, breakable, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-color-frame, rightrule=.15mm, opacityback=0, left=2mm]
...
Our stat is 0.74 and the confidence interval limits are 0.725 and 0.753.
...
\begin{verbatim}
  # A tibble: 3 x 3
    ...
    <chr>               <dbl>    <dbl>
  1 intercept          -0.678   -0.459
  2 length_ratio_log   -1.79    -1.49 
  3 modalitywritten     0.818    1.23
\end{verbatim}
