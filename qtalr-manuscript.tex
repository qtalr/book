...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, leftrule=.75mm, colframe=quarto-callout-color-frame, left=2mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, breakable, colback=white, leftrule=.75mm, arc=.35mm, left=2mm, coltitle=black, rightrule=.15mm, toptitle=1mm, titlerule=0mm, opacityback=0]
