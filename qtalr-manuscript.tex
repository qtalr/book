...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, colframe=quarto-callout-color-frame, toprule=.15mm, leftrule=.75mm, breakable, rightrule=.15mm, arc=.35mm, opacityback=0, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-caution-color-frame, breakable, arc=.35mm, toptitle=1mm, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, coltitle=black, opacityback=0, bottomrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, rightrule=.15mm, toprule=.15mm]
