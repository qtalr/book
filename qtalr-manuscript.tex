...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, rightrule=.15mm, breakable, opacityback=0, leftrule=.75mm, left=2mm, arc=.35mm, colframe=quarto-callout-color-frame, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colback=white, breakable, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, rightrule=.15mm, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, leftrule=.75mm, left=2mm, toptitle=1mm, colframe=quarto-callout-caution-color-frame, toprule=.15mm]
