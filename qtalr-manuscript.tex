...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, colback={codebgcolor}, enhanced, breakable, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
\@ifpackageloaded{fontawesome5}{}{\usepackage{fontawesome5}}
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, left=2mm, colback=white, breakable, rightrule=.15mm, colframe=quarto-callout-color-frame, toprule=.15mm, arc=.35mm, leftrule=.75mm]
...
samples, the proportion statistic ranges from 0.48 to 0.53. Importantly
...
# A tibble: 3 x 3
  ...
  <chr>               <dbl>    <dbl>
1 intercept          -0.686   -0.453
2 length_ratio_log   -1.79    -1.49 
3 modalitywritten     0.820    1.24 
\end{verbatim}
