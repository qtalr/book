...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, colback={codebgcolor}, breakable, frame hidden, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
\@ifpackageloaded{fontawesome5}{}{\usepackage{fontawesome5}}
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, breakable, opacityback=0, left=2mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-color-frame, arc=.35mm]
...
other supplementary materials including setup Guides, Instructor
materials, and Errata & GitHub \\
...
{\includegraphics[width=0.7\textwidth,height=\textheight]{part_1/figures/ta-ds-venn.drawio.png}}
