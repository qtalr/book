...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, sharp corners, breakable, enhanced, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
\@ifpackageloaded{fontawesome5}{}{\usepackage{fontawesome5}}
\makeatother
...
(\citeproc{ref-R-quarto}{Allaire and Dervieux 2024}) and the
\texttt{bookdown} package (\citeproc{ref-R-bookdown}{Xie 2024}) for R.
The source code for this book is available on
\href{https://github.com/qtalr/book}{GitHub}.

This version of the textbook was built with R version 4.3.3 (2024-02-29)
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, breakable, arc=.35mm, left=2mm, colback=white, opacityback=0, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, leftrule=.75mm]
...
(\citeproc{ref-R-workflowr}{Blischak, Carbonetto, and Stephens 2023}),
...
well as inferential analysis Chapter~\ref{sec-inference}), but there are
also some key differences. Consider the workflow in
...
\includegraphics{prediction_files/figure-pdf/fig-pda-class-tune-hyperparameters-tokenfilter-evaluate-workflow-cv-confusion-1.pdf}
...
>   .metric .estimator   mean     n std_err .config             
>   <chr>   <chr>       <dbl> <int>   <dbl> <chr>               
> 1 rmse    standard   16.3      10  0.252  Preprocessor1_Model1
> 2 rsq     standard    0.483    10  0.0167 Preprocessor1_Model1
\end{verbatim}

\end{example}

The performance for the decision tree is worse than the regularized
linear regression model. The RSME is 16.3 and the \(R^2\) is 0.483. And,
...
\includegraphics{prediction_files/figure-pdf/fig-pda-reg-final-fit-vip-visualize-1.pdf}
...
>   <chr>               <dbl>    <dbl>
> 1 intercept          -0.683   -0.449
> 2 length_ratio_log   -1.78    -1.49 
> 3 modalitywritten     0.790    1.23
\end{verbatim}
...
\includegraphics{inference_files/figure-pdf/fig-ida-num-uni-hist-dens-log-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, toprule=.15mm, bottomtitle=1mm, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, arc=.35mm, toptitle=1mm, left=2mm, titlerule=0mm, opacityback=0, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
Chapter~\ref{sec-framing-research}, many of these components are already
in place. The steps taken to identify an area and a problem or gap in
the literature find themselves in the introduction. This section builds
the case for the research and provides the context for the research
...
produce the findings in your reproducible research project.
...
research plans. The steps outlined in Chapter~\ref{sec-framing-research}
are the foundation for the various elements of the research narrative.
...
\textbf{What}: \href{https://github.com/qtalr/lab-11}{Future-proof
research}\\
