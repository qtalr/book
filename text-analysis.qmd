...
Content:
- [ ] Update 'language applications' image to include: ChatGPT, Spam detection, etc.
- [ ] Consider making the first two sections ('Making sense...' and 'Data Analysis') more concise and language-centered (word frequency, grammatical frequency in written and spoken language?)
- [ ] Add more context and examples to 'Text Analysis' section
- [ ] Consider adding information from my "Quantitative Approaches to Language Research: Why Frequency Matters" presentation
  - [ ] "Everything about science is changing because of the impact of information technology and the data deluge." @Gray2007
- [ ] Insert a section on Reproducible Research in this chapter and underscore how important it is to be able to reproduce your results: for yourself, for others, and for the scientific community. 
...
<!-- The first section discusses how the brain processes information and makes sense of the world around us. It highlights how our brains compress raw experience into heuristic understanding, which can give us an impression that we understand the world in more detail than we actually do. The text also mentions how the internet has increased our ability to experience larger slices of the world, but reading, watching, and listening to every file that is currently accessible on the web or has been archived is still impossible. -->
...
<!-- The second section talks about how science helps us overcome our inherent limitations in understanding by drawing on carefully and purposefully collected slices of observable experience. It explains how science collects carefully selected slices of observable experience, submits them to analysis through reproducible procedures, and reports the results for others to evaluate. This process is repeated, modifying and manipulating the procedures, asking new questions, and positing new explanations, all in an effort to bring the complex into tangible view. -->
...
### Triad of skills needed for Data Science

<!-- Data Science is not predicated on data alone. Turning data into insight takes computing skills (i.e. programming), statistical knowledge, and domain expertise. In this section, we discuss the triad of skills needed for Data Science and how they are used to turn data into actionable insights -->
...
These advances, however, are not predicated on data alone. As envisioned by researchers at Bell Labs, turning data into insight it takes **computing skills** (i.e. programming), **statistical knowledge**, and, importantly, **domain expertise**. This triad has been popularly represented in a Venn diagram @fig-intro-data-science-venn.
...
#| out-width: 80%
knitr::include_graphics("figures/text-analysis/data-science-venn-paper.png")
```
...
#| echo: false
#| fig-cap: 'Well-known language applications'
knitr::include_graphics("figures/text-analysis/well-known-language-applications.png")
```
...
```{mermaid}
%%| label: fig-data-colletion-methods
%%| fig-cap: "Experimental and observational data collection methods."
%%| out-width: 80%
...
Text analysis, also known as text mining or text analytics, is the process of using computational techniques to extract meaningful insights and patterns from textual data. It involves processing large volumes of unstructured or structured data such as written texts, social media posts, emails, news articles, and other forms of online content to uncover hidden patterns, trends, sentiment, and themes.

Text analysis uses natural language processing (NLP), machine learning (ML), and statistical algorithms to identify key features within the text, such as keywords, topics, entities, and relationships between words. For linguists, text analysis is an important tool gain a deeper understanding of language structure and use in different contexts.
-->
...
Analyzing customer reviews to identify common themes that can help improve products and services.
Sentiment analysis of social media posts to better understand the public response to marketing campaigns.
2. Finance
Sentiment analysis of financial news articles and social media posts to predict stock prices.
Identifying legal and compliance risks by analyzing communication data and identifying potentially dubious behavior (e.g. insider trading).
3. Politics and Government
Analyzing political speeches and campaign materials to understand the key issues and messaging behind political candidates.
Identifying propaganda and disinformation campaigns on social media in order to prevent election interference.
4. Healthcare
Analyzing patient feedback surveys to identify areas for improvement in healthcare services.
Sentiment analysis of social media posts to monitor mental health conditions and predict outbreaks of disease.
5. Education
Analyzing student essays to assess writing ability and provide feedback for improvement.
Analyzing syllabi and course descriptions to evaluate curricula and identify areas for improvement.

Academic Applications

1. Linguistics
Analyzing language use and variation across different cultures and communities.
Identifying patterns of language change over time through corpus linguistics.
2. Sociology
Analyzing social media data to study social movements and societal reaction to events.
Quantitative content analysis of media narratives to better understand how various groups are portrayed.
3. Psychology
Sentiment analysis of social media posts and online forums to study emotional states and identify the causes of depression or anxiety.
Analyzing transcripts of therapy sessions to evaluate the effectiveness of different treatments.
4. Anthropology
Studying cultural change and linguistic diversity in historical documents and written texts.
Sentiment analysis and topic modeling of ethnographic field notes to study cross-cultural perceptions of social phenomena.
5. History
Analyzing historical texts to study the evolution of language and communication over time.
Collecting and analyzing data on historical events and personalities to understand their impact on society and culture.

-->


**Text analysis** is the application of data analysis procedures from data science to derive insight from textual data collected through observational methods. I have deliberately chosen the term 'text analysis' to avoid what I see are the pitfalls of using some other common terms in the literature such as Corpus Linguistics, Computational Linguistics, or Digital Humanities. In @fig-academic-language-applications I have highlighted some of the academic fields that employ text analysis.

<!-- Academic applications in language -->

```{r}
#| label: fig-academic-language-applications
#| echo: false
#| fig-cap: 'Some academic applications of text analysis.'
#| out-width: 80%
knitr::include_graphics("figures/text-analysis/academic-language-applications.png")
```
...
In **Part II "Foundations"** we will build up a framework to contextualize quantitative data analysis using the Data to Insight (DIKI) Hierarchy in @fig-diki-hierarchy-bw [^text-analysis-4].

[^text-analysis-4]: Adapted from @Ackoff1989
...
#| echo: false
#| out-width: 80%
knitr::include_graphics("figures/text-analysis/diki-hierarchy-paper.png")
```
...
knitr::include_graphics("figures/text-analysis/diki-hierarchy-bw.png")
```
...
- Fork a quantitative text analysis project on GitHub and clone it to your local machine. Run the code and explore the results. <!-- provide a few sources suitable for this exercise -->
- ...
- Explore the following resources and identify a quantitative text analysis project. [Rpubs](https://rpubs.com/), [GitHub](https://github.com), [DataCamp](https://datacamp.com), [Kaggle](https://kaggle.com), [R-bloggers](https://r-bloggers.com).
