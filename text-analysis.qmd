...
# Text analysis {#sec-text-analysis-in-context}
...
<!--
- [x] Revise second draft (~6k words) to make it more concise. Bring it within 5k words.
...
**What**: [Workspace, Vectors](https://github.com/qtalr/lessons)\
...
<!-- [ ] Collapse this and following main sections (Data analysis)  -->
...
<!--
The world around us is complex, with countless actions and interactions that can be difficult to comprehend. As individuals, we gain knowledge and develop a heuristic understanding of the world through our experiences, regardless of our educational background. Our minds process sensory inputs and enable us to make predictions and understand cause and effect. This ability often goes unnoticed, but it plays a crucial role in how we interact with the world.

You may have never stopped to think about where this predictive knowledge comes from. It's often dismissed as "common sense." However, it's an incredible display of the brain's ability to process information without explicitly informing our conscious mind.

Now, you may be wondering what all of this has to do with text analysis, which is the focus of this textbook. There are two key points to consider: First, the world generates an enormous amount of data in real-time, which can be overwhelming. Second, as individuals, we have a limited perspective on the world. These points are important for framing our journey into text analysis.

It's important to recognize that no one can experience everything all the time. Even with the advent of the internet, our capacity to understand the world remains limited. Just think about the sheer volume of information accessible online, from archived websites to resources like Wikipedia. Even though Wikipedia is a massive collection of knowledge, it only represents a small fraction of the written language produced on the web. This scale is worth considering as we delve into the topic of text analysis.Cut the fluff: To my second point, our brains efficiently make sense of the world through evolutionary twists, taking shortcuts to compress raw experience into heuristic understanding. The brain is not a supercomputer that stores every experience in detail, but it excels in making associations and predictions to help us navigate the complex world. Our brains may give us the impression that we understand the world in greater detail than we actually do. However imperfect, our memory works well enough for practical purposes.

In summary, as humans, (1) we cannot experience every aspect of life due to our individuality, and (2) our memories are not recorded with perfect precision, so absolute trust in our intuitions is not warranted.
...
So wait, this is a textbook on text analysis, right? So what does all this have to do with that? Well, there are two points to make that are relevant for framing our journey: (1) the world is constantly churning out data in real-time at a scale that is daunting and (2) for all the power of the brain that works so efficiently behind the scenes making sense of the world, we are one individual living one life that has a limited view of the world at large. Let me expand on these two points a little more.

First, let's be clear. There is no way for anyone to experience all things at all times. But even severely reduced slices of reality are still vastly outside of our experiential capacity, at least in real-time. One could make the point that since the inception of the internet, an individual's ability to experience larger slices of the world has increased. But could you imagine reading, watching, and listening to every file that is currently accessible on the web? Or has been? (See the [Wayback Machine](https://web.archive.org/).) Scale this down even further; let's take Wikipedia, the world's largest encyclopedia. Can you imagine reading every wiki entry? As large as a resource such as Wikipedia is [^text-analysis-1], it is still a small fragment of the written language that is produced on the web, just the web [^text-analysis-2]. Consider that for a moment.
...
This point is key -- our brains are doing some amazing work, but that work can give us the impression that we understand the world in more detail than we actually do. Let's do a little thought experiment. Close your eyes and think about the last time you saw your best friend. What were they wearing? Can you remember the colors? If you're like me, or any other human, you probably will have a pretty confident feeling that you know the answers to these questions, and there is a chance you are right. But it has been demonstrated in numerous experiments on human memory that our confidence does not correlate with accuracy [@Talarico2003; @Roediger2000]. You've experienced an event, but there is no real reason that we should bet our lives on what we experienced. It's a little bit scary, for sure, but the magic is that it works 'good enough' for practical purposes.
...
Observational approaches show complementary strengths and shortcomings. Whereas experimental approaches may diverge from natural language use, observational approaches strive to identify and collected language behavior data in natural, uncontrolled, and unmonitored contexts, as seen in @fig-data-collection-methods. In this way, observational approaches do not have to question to what extent the language behavior data is or is not performed as a natural communicative act.
...
In the ideal, a robust science of language will include insight from both experimental and observational approaches [@Gilquin2009]. And evermore there is greater appreciation for the complementary nature of experimental and observational approaches and a growing body of research which highlights this recognition.
...
**What**: [Academic writing with Quarto](https://qtalr.github.io/qtalrkit/articles/recipe-1.html)\
...
**What**: [Academic writing with Quarto](https://github.com/qtalr/lab-01)\
