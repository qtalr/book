...
<!-- preparation: normalization, tokenization, enrichment: recoding, generation, integration -->
...
The data dictionary gives us a sense of the variables in the dataset. Let's read in the dataset and preview the first 10 lines to get a sense of the values in the dataset, as in @exm-td-swda-dataset-read.

::: {#exm-td-swda-dataset-read}
```r
# Read in the dataset
swda_curated_tbl <-
...
The CABNC dataset contains a number of variables describing conversations between speakers of British English. Now let's look at the dataset and preview the first 10 lines to get a sense of the values in the dataset, as in @exm-td-cabnc-dataset-read.

::: {#exm-td-cabnc-dataset-read}
```r
# Read in the dataset
cabnc_curated_tbl <-
...
::: {#tbl-td-cabnc-tokenization-words-example}
...
Example of tokenizing the `utt_text` variable into words.
:::

Comparing @tbl-td-cabnc-tokenization-words-example to the first line of the output of @exm-td-swda-dataset-read, we can see that we want to segment the words in the `utt_text` and then have each segment appear as a separate observation, retaining the relevant metadata variables.
