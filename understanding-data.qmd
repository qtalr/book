...
- [ ] Revise second draft and make more concise (e.g., remove unnecessary details, simplify language, etc.) to within 6-7k words. Current version (9,387k) 2023-07-20
...
include_graphics("figures/understanding-data/word-mapper.png")
```
:::
...
<!-- [ ] Consider moving 'stopword removal' to merging, in this case anti_joining -->
...
//FIXME: *Reorder: recoding and tokenization. Recoding/ text-normalization are column-wise operations, tokenization is row-wise. Then generation/merging are row- and colum-wise.*
