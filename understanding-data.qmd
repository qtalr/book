...
- [ ] Revise second draft and make more concise (e.g., remove unnecessary details, simplify language, etc.) to within 6-7k words. Current version (9,970) 2023-11-09
...
# pacman::p_load(tidytext, readtext)
```
...
<!--
- Definition and examples
- Sampling techniques (e.g., size, random, stratified, balanced)
-->
...
<!--
- [ ] Revise/ add conceptual and technical questions.
-->
